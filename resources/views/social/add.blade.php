    ...
    <div class="container col-md-06">
        ...
        <form method="POST" action="{{ route('notice.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control character" id="social_name" name="social_name"
                    aria-describedby="emailHelp" required>
            </div>
            <br />
            <div class="form-group">
                <label for="exampleInputEmail1">Social Link</label>
                <input type="text" class="form-control character" id="link" name="link" aria-describedby="emailHelp"
                    required>
            </div>
            <br />
