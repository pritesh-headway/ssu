                ...
                <div class="panel h-full">
                    <div class="space-y-9">
                        <div class="flex items-center">
                            ...
                            <div class="flex-1">
                                <div class="mb-2 flex font-semibold text-white-dark">
                                    <h6>Number Of Coupons (Include Declined)</h6>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="flex-1">
                                <div class="mb-2 flex font-semibold text-white-dark">
                                    <h6>Number Of Coupons (Without Declined)</h6>
                                    <p class="ltr:ml-auto rtl:mr-auto">{{ $totalCoupn - $declinedCouponSum }}</p>
                                </div>
                                {{-- <div class="h-2 rounded-full bg-dark-light shadow dark:bg-[#1b2e4b]">
                                    <div class="h-full w-11/12 rounded-full bg-gradient-to-r from-[#7579ff] to-[#b224ef]"
                                        style="width: 60%">
                ...
                <div class="panel h-full">
                    ...
                    <div class="space-y-9">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="flex-1">
                                <div class="mb-2 flex font-semibold text-white-dark">
                                    <h6>Todays Total Remaining Coupons</h6>
                            ...
                            <tbody>
                                ...
                                <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                    ...
                                    <td>
                                        ...
                                        <span
                                            class="badge bg-warning shadow-md dark:group-hover:bg-transparent">Delivered</span>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <?php } } } ?>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="flex-1">
                                    <div class="mb-2 flex font-semibold text-white-dark">
                                        ...
                                        <p class="ltr:ml-auto rtl:mr-auto">{{ $declinedCoupon }}</p>
                                    </div>
                                    {{-- <div class="h-2 w-full rounded-full bg-dark-light shadow dark:bg-[#1b2e4b]">
                                        <div class="h-full w-full rounded-full bg-gradient-to-r from-[#f09819] to-[#ff5858]"
                                            style="width: {{ $enquiryCoupn / 100 }}%">
