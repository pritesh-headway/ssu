...
<body>
    ...
    <div class="container">
      ...
      $number = '';
      if(isset($_POST['btn'])) {
        $customer_name = isset($data->customer_name) ? ' \a\a'.$data->customer_name.'\a\a ' : '';
        $city = isset($data->city) ? $data->city.'\a\a' : '';
        $prize = $prize.'\a\a';
        $number = $_POST['number'].'\a\a '."$customer_name"." $city"." $prize";
      }
    ?>
...
?>
      ...
      $prizes = DB::table('prizes')
        ...
        ->where('status', '1')->get();
      ?>
        <div class="logo"><img src="{{ url('assets/images/auth/login.svg') }}" width="50%"> </div>

        <form action="" method="POST">
            @csrf
            <div class="form-group">
                <label for="email">Event Select:</label>
                <select name="event" class="form-control" required>
                    <option value='1'>SSU 2024</option>
                </select>
            </div>
            <div class="form-group">
                <label for="email">Day Select:</label>
            ...
            <div class="form-group">
                <label for="email">Select Pize:</label>
                <select name="prize" class="form-control" required>
            ...
            <button type="reset" name="btn" class="btn btn-info">Reset</button>
        </form>
    </div>
    <?php } ?>
    </div>
